...
description: Prepare a month-end close using the shared DeepLedger procedure and Close Sheet contract. Use when the user asks to close a month, prepare its adjusting entries, or complete the close checklist for human review.
---

# Month End Close

Prepare the Close Sheet, its supporting checks and proposed entries for human sign-off.
...
```text
getGuide(guideType="month_end_closing")
```
...
New close adjustments remain proposed until approved. Final close sign-off
belongs to the human reviewer in the portal.
